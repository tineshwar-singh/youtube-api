                    ...
                    <article>
                        <div className="leftMenuBlock">
                            <div className="logoBlock">
                                <span className="bars">
                                    ...
                                    <g className="style-scope yt-icon"><path d="M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z" className="style-scope yt-icon" /></g></svg>
                                </span>
                                <a className="navbar-brand" href="/">
                                    <span className="logo">
                                        <svg viewBox="0 0 200 60" preserveAspectRatio="xMidYMid meet" focusable="false" className="style-scope ytd-topbar-logo-renderer">
                                        <g viewBox="0 0 200 60" preserveAspectRatio="xMidYMid meet" className="style-scope ytd-topbar-logo-renderer">
                                            <g className="style-scope ytd-topbar-logo-renderer">
                                                <path fill="#FF0000" d="M63,14.87c-0.72-2.7-2.85-4.83-5.56-5.56C52.54,8,32.88,8,32.88,8S13.23,8,8.32,9.31
                                                c-2.7,0.72-4.83,2.85-5.56,5.56C1.45,19.77,1.45,30,1.45,30s0,10.23,1.31,15.13c0.72,2.7,2.85,4.83,5.56,5.56
                                                C13.23,52,32.88,52,32.88,52s19.66,0,24.56-1.31c2.7-0.72,4.83-2.85,5.56-5.56C64.31,40.23,64.31,30,64.31,30
                                                S64.31,19.77,63,14.87z" className="style-scope ytd-topbar-logo-renderer" />
                                                <polygon fill="#FFFFFF" points="26.6,39.43 42.93,30 26.6,20.57" className="style-scope ytd-topbar-logo-renderer"/>
                                            </g>
                                            <g className="style-scope ytd-topbar-logo-renderer">
                                                <g id="youtube-paths" className="style-scope ytd-topbar-logo-renderer" >
                                                    ...
                                                    c0,2.04,0.16,3.51,0.49,4.4c0.33,0.9,0.93,1.35,1.8,1.35C98.71,45.06,99.31,44.61,99.66,43.71z" className="style-scope ytd-topbar-logo-renderer"/>
                                                    ...
                                                    c0.21-1.44,0.67-3.85,1.39-7.24l2.56-11.6h6.16L83.7,36.61v12.23h-6.11V36.61z" className="style-scope ytd-topbar-logo-renderer"/>
                                                    ...
                                                    c0.54,0,1.06-0.16,1.55-0.49c0.49-0.33,0.86-0.75,1.1-1.26V21.28H126.45z" className="style-scope ytd-topbar-logo-renderer"/>
                                                    <path fill="#282828" d="M158.27,21.28v27.55h-4.85l-0.54-3.37h-0.13c-1.32,2.55-3.3,3.82-5.93,3.82c-1.83,0-3.18-0.6-4.05-1.8
                                                    c-0.87-1.2-1.3-3.07-1.3-5.62V21.28h6.2v20.23c0,1.23,0.13,2.11,0.4,2.63c0.27,0.52,0.72,0.79,1.35,0.79
                                                    c0.54,0,1.06-0.16,1.55-0.49c0.49-0.33,0.86-0.75,1.1-1.26V21.28H158.27z"className="style-scope ytd-topbar-logo-renderer"/>
                                                    <path fill="#282828" d="M143.31,16.11h-6.16v32.72h-6.07V16.11h-6.16v-4.99h18.38V16.11z" className="style-scope ytd-topbar-logo-renderer"/>
                                                    ...
                                                    c0.13,1.17,0.2,2.83,0.2,4.99V36.93z" className="style-scope ytd-topbar-logo-renderer"/>
                                                </g>
                                            </g>
                                        </g>
                                        </svg>
                        ...
                        <div className="rightMenuBlock">
                            ...
                            <div className="menuBlock">
                                <div className="creator">Tineshwar Singh</div>
                            </div>
                        </div>
                    </article>
                </section>
